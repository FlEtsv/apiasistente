package com.example.apiasistente.shared.security;
...
/**
 * Componente de seguridad para App Permission.
 */
public enum AppPermission {
     ...
     * Si estÃ¡ vacÃ­o y {@code blankMeansAll} es true, devuelve acceso total.
     */
